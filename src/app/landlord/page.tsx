  ...
  return (
    <div className="min-h-screen bg-[#E5E0D8] py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="bg-[#231F20] text-[#E5E0D8] p-4 rounded-xl border border-[#00A8E8]/30 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-8 space-y-4">
            ...
            <div className="space-y-3">
              {applications.map((app) => (
                <div
                  key={app.id}
                  className="bg-[#FAFAFA] p-5 rounded-xl border border-[#E5E0D8] shadow-sm hover:shadow transition-all space-y-3"
                >
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="bg-[#FAFAFA] p-6 rounded-xl border border-[#E5E0D8] space-y-3">
              <div className="flex items-center justify-between">
              ...
              <div className="space-y-2 text-xs font-mono">
                {properties.slice(0, 3).map((p) => (
                  <div
                    key={p.id}
                    className="p-2.5 rounded bg-white border border-[#231F20]/10 flex items-center justify-between"
                  >
                    <div>
