  ...
  return (
    <div className="min-h-screen bg-[#E5E0D8] py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 space-y-8">
        {/* Header */}
        <div className="pb-4 border-b border-[#231F20]/10">
        ...
        <form onSubmit={handleSave} className="space-y-6">
          ...
          <div className="bg-[#FAFAFA] rounded-xl border border-[#E5E0D8] p-6 space-y-4">
          ...
          <div className="bg-[#FAFAFA] rounded-xl border border-[#E5E0D8] p-6 space-y-4">
            ...
            <div className="space-y-3 font-mono text-xs text-[#231F20]">
              <label className="flex items-center gap-2.5 cursor-pointer">
                <input type="checkbox" defaultChecked className="rounded text-[#4A6B32]" />
          ...
          <div className="bg-[#FAFAFA] rounded-xl border border-[#E5E0D8] p-6 space-y-4">
            ...
            <div className="pt-2 flex items-center justify-between">
              ...
              <button
                type="submit"
                className="px-6 py-2.5 rounded-md bg-[#B86A36] hover:bg-[#A05A2C] text-white font-mono text-xs font-bold transition-colors shadow"
              >
