    ...
    <div className="flex flex-col min-h-screen overflow-hidden">
      ...
      <section className="relative overflow-hidden pt-12 pb-20 md:pt-20 md:pb-28 border-b border-[#231F20]/10 bg-gradient-hero">
        ...
        <div className="absolute inset-0 z-0">
          <motion.div
            initial={prefersReduced ? undefined : { scale: 1.06 }}
            animate={{ scale: 1 }}
          ...
          <div className="absolute inset-0 bg-[#E5E0D8]/70 backdrop-blur-[0.9px]" />
        </div>
              ...
              <FadeIn delay={0.35}>
                <div className="pt-2 flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                  ...
                  >
                    <Link
                      href="/properties"
                      className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-md bg-[#00A8E8] hover:bg-[#0277BD] text-white font-medium text-base shadow-md transition-all group w-full sm:w-auto"
                    >
                  ...
                  >
                    <Link
                      href="/how-it-works"
                      className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-md bg-transparent hover:bg-[#231F20]/5 text-[#231F20] border border-[#231F20]/25 font-medium text-base transition-colors w-full sm:w-auto"
                    >
      ...
      <section className="py-16 bg-[#E5E0D8] border-b border-[#231F20]/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn className="flex flex-col md:flex-row md:items-end justify-between mb-10">
            <div>
            ...
            <Link
              href="/properties"
              className="mt-4 md:mt-0 inline-flex items-center gap-1.5 text-sm font-semibold text-[#231F20] hover:text-[#B86A36] transition-colors group"
            >
      ...
      <section className="py-16 bg-[#F3F0EA] border-b border-[#231F20]/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Pillar 1 */}
            <StaggerItem>
              <MotionCard className="p-6 rounded-xl bg-[#E5E0D8] border border-[#E5E0D8] space-y-4 h-full">
      ...
      <section className="py-16 bg-[#E5E0D8] border-b border-[#231F20]/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <StaggerContainer className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <StaggerItem>
              <MotionCard className="p-5 rounded-lg bg-[#FAFAFA] border border-[#E5E0D8] space-y-3 relative h-full">
      ...
      <section className="py-16 bg-[#231F20] text-[#E5E0D8]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Tenant CTA */}
            <StaggerItem>
              <MotionCard className="p-8 rounded-xl bg-[#231F20] border border-[#00A8E8]/30 space-y-4 flex flex-col justify-between h-full">
            ...
            {/* Landlord CTA */}
            <StaggerItem>
              <MotionCard className="p-8 rounded-xl bg-[#231F20] border border-[#B86A36]/30 space-y-4 flex flex-col justify-between h-full">
                <div className="space-y-3">
