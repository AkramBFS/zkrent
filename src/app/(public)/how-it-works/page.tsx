...
export default function HowItWorksPage() {
  return (
    <div className="min-h-screen bg-[#E5E0D8] py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
            ...
            <div className="bg-[#FAFAFA] rounded-2xl border-2 border-red-200 p-6 sm:p-8 space-y-6 flex flex-col justify-between shadow-sm">
            ...
            {/* ZkRent application */}
            <div className="bg-[#231F20] text-white rounded-2xl border-2 border-[#00A8E8]/50 p-6 sm:p-8 space-y-6 flex flex-col justify-between shadow-xl relative overflow-hidden">
              <div className="space-y-4">
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4 font-mono text-xs">
            <div className="bg-[#FAFAFA] p-6 rounded-xl border border-[#E5E0D8] grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
              <div className="md:col-span-1 font-serif text-3xl font-bold text-[#B86A36]">01</div>
              <div className="md:col-span-4">
                <h3 className="font-serif text-lg font-bold text-[#231F20]">1. Choose a Property</h3>
                <p className="text-[#3D3531]">Inspect upfront ZK requirements</p>
              </div>
            ...
            <div className="bg-[#FAFAFA] p-6 rounded-xl border border-[#E5E0D8] grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
              <div className="md:col-span-1 font-serif text-3xl font-bold text-[#B86A36]">02</div>
              <div className="md:col-span-4">
                <h3 className="font-serif text-lg font-bold text-[#231F20]">2. Pay $5 Verification Fee</h3>
                <p className="text-[#3D3531]">Initialize on-chain session</p>
              </div>
              <div className="md:col-span-7 text-[#3D3531] leading-relaxed">
            ...
            <div className="bg-[#FAFAFA] p-6 rounded-xl border border-[#E5E0D8] grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
              <div className="md:col-span-1 font-serif text-3xl font-bold text-[#B86A36]">03</div>
              <div className="md:col-span-4">
                <h3 className="font-serif text-lg font-bold text-[#231F20]">3. Enter Private Credentials</h3>
                <p className="text-[#3D3531]">Local WebAssembly memory only</p>
              </div>
              <div className="md:col-span-7 text-[#3D3531] leading-relaxed">
            ...
            <div className="bg-[#FAFAFA] p-6 rounded-xl border border-[#E5E0D8] grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
              <div className="md:col-span-1 font-serif text-3xl font-bold text-[#B86A36]">04</div>
              <div className="md:col-span-4">
                <h3 className="font-serif text-lg font-bold text-[#231F20]">4. Generate ZK Proof</h3>
                <p className="text-[#3D3531]">Halo2 SNARK circuit compilation</p>
              </div>
              <div className="md:col-span-7 text-[#3D3531] leading-relaxed">
            ...
            <div className="bg-[#FAFAFA] p-6 rounded-xl border border-[#E5E0D8] grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
              <div className="md:col-span-1 font-serif text-3xl font-bold text-[#B86A36]">05</div>
              <div className="md:col-span-4">
                <h3 className="font-serif text-lg font-bold text-[#231F20]">5. Landlord Receives Sealed Verdict</h3>
                <p className="text-[#3D3531]">Anonymized review & receipt audit</p>
              </div>
              <div className="md:col-span-7 text-[#3D3531] leading-relaxed">
        ...
        {/* CTA Footer */}
        <div className="p-8 rounded-2xl bg-[#231F20] text-white text-center space-y-4">
          ...
          <div className="pt-2 flex justify-center gap-4">
            <Link
              href="/properties"
              className="px-6 py-3 rounded-md bg-[#B86A36] hover:bg-[#A05A2C] text-white font-mono text-xs font-bold transition-colors shadow"
            >
              Browse Properties →
            </Link>
          </div>
