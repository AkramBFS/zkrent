    ...
    <div className="min-h-screen bg-[#E5E0D8] py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="flex items-center justify-between">
          <Link
            href="/properties"
            className="inline-flex items-center gap-1.5 text-sm font-mono text-[#3D3531] hover:text-[#231F20] transition-colors"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <div className="bg-[#FAFAFA] p-6 rounded-xl border border-[#E5E0D8] space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {property.amenities.map((amenity, idx) => (
                  <div key={idx} className="flex items-center gap-2.5 text-sm text-[#231F20] font-mono">
            ...
            <div className="bg-[#231F20] text-[#E5E0D8] p-6 rounded-xl border border-[#00A8E8]/30 space-y-4">
