  ...
  return (
    <div className="min-h-screen bg-[#E5E0D8] py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        {/* Top Greeting Header */}
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 border-b border-[#231F20]/10">
          <div>
        ...
        {pendingReveals.length > 0 && (
          <div className="p-5 rounded-xl bg-[#231F20] text-[#E5E0D8] border border-[#B86A36] shadow-lg flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            ...
            <Link
              ...
              className="px-4 py-2 rounded-md bg-[#B86A36] hover:bg-[#A05A2C] text-white text-xs font-mono font-bold whitespace-nowrap shadow transition-colors"
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
          <div className="p-5 rounded-xl bg-[#FAFAFA] border border-[#E5E0D8] space-y-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-8 space-y-4">
            ...
            <div className="space-y-3">
              {myApplications.map((app) => (
                <div
                  key={app.id}
                  className="bg-[#FAFAFA] p-5 rounded-xl border border-[#E5E0D8] shadow-sm hover:shadow transition-all space-y-4"
                >
                  ...
                  <div className="pt-3 border-t border-[#231F20]/10 flex items-center justify-between">
                    ...
                    <Link
                      ...
                      className="px-4 py-1.5 rounded bg-[#00A8E8] hover:bg-[#0277BD] text-white text-xs font-medium transition-colors"
                    >
                      {app.paymentStatus === 'unpaid'
                        ? 'Pay Fee ($5.00)'
                        : app.status === 'pending_verification'
          ...
          <div className="lg:col-span-4 space-y-6">
            {/* Quick Actions Card */}
            <div className="bg-[#FAFAFA] p-6 rounded-xl border border-[#E5E0D8] space-y-4">
            ...
            <div className="bg-[#231F20] text-[#E5E0D8] p-6 rounded-xl border border-[#00A8E8]/30 space-y-3">
