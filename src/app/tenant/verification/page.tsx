  ...
  return (
    <div className="min-h-screen bg-[#E5E0D8] py-8">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        {/* Info Banner */}
        <div className="bg-[#231F20] text-[#E5E0D8] p-5 rounded-xl border border-[#00A8E8]/30 flex items-start gap-3">
          ...
          <div className="space-y-6">
            {verifiedApplications.map((app) => {
              ...
              return (
                <div
                  key={app.id}
                  className="bg-[#FAFAFA] rounded-xl border border-[#E5E0D8] p-6 shadow-sm space-y-5"
                >
                  ...
                  <div className="flex items-center justify-between pt-2">
                    ...
                    <Link
                      ...
                      className="px-4 py-2 rounded bg-[#231F20] text-white text-xs font-mono hover:bg-[#3D3531] transition-colors"
                    >
