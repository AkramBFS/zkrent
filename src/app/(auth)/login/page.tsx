    ...
    <div className="w-full max-w-md bg-[#FAFAFA] rounded-2xl border border-[#E5E0D8] p-8 shadow-xl space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 font-mono text-xs">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full py-3 rounded-lg bg-[#00A8E8] hover:bg-[#0277BD] text-white font-bold text-xs font-mono transition-colors shadow flex items-center justify-center gap-2 disabled:opacity-50"
        >
