...
export function VerifyReceiptDrawer({
  ...
  return (
    <div className="border border-[#E5E0D8] rounded-lg bg-[#FAFAFA] overflow-hidden transition-all shadow-sm">
      {/* Header / Toggle Button */}
      <button
        onClick={() => setIsExpanded(!isExpanded)}
        className="w-full px-5 py-4 flex items-center justify-between text-left hover:bg-[#E5E0D8]/60 transition-colors"
      >
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-md bg-[#231F20] text-[#00A8E8] flex items-center justify-center border border-[#00A8E8]/30">
            ...
            <div className="p-3 rounded bg-[#231F20] border border-[#00A8E8]/20">
              <div className="flex items-center justify-between text-xs text-[#908682] mb-1 font-mono">
                ...
                <button
                  ...
                  className="text-[#00A8E8] hover:text-white flex items-center gap-1"
                >
